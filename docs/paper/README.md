...
2026-08-25 第二轮精修完成后的正式构建：

- 17 页；
- XeLaTeX/BibTeX 编译成功；
- 无 unresolved reference/citation；
- 无 Overfull box；
- 最终 PDF 已逐页渲染检查，结论独立起页，正文、参考文献和附录之间无浮动体串页。

第二轮主要完成结构性压缩和版式收尾：删除与附录/部署章节重复的信息，收紧第 4 节筛分映射主线，强化第 5 节数量统计与质量代理统计的对照，并固定第 6 节关键表格的章节归属。当前正文不再进行无目标扩写，后续修改以事实纠错、赛题要求变化或答辩材料联动为主。
