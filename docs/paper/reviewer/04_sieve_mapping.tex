...
\node[box,fill=blue!7,right=0.8cm of grain] (proj) {\begin{tikzpicture}[scale=0.7]
...
\node[box,fill=orange!8,right=0.8cm of proj] (sieve) {\begin{tikzpicture}[scale=0.7]
